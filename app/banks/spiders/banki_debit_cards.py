...
from banks.items import BankiDebitCardLoader, normalize_spaces


class BankiDebitCardsSpider(scrapy.Spider):
    ...
    def parse_items(self, response):
        loader = BankiDebitCardLoader(response=response)
        ...
        loader.add_xpath('debit_cashback', self.getsel('alltext', 'Cash Back'))
        loader.add_xpath('debit_bonuses', self.getsel('alltext', 'Бонусы'))
